...
\end{itemize}
Fra le opzioni elencate, è stato scelto di mettere in atto la seconda, attribuendo all'arbitro il ruolo di orchestratore della partita.
...
\begin{figure}[H]
	...
	\caption{Diagramma di sequenza del sistema.  \label{general-sequence-diagram}}
\end{figure}
